package org.Farmacia.drogaria.controller;

import java.util.List;

import org.Farmacia.drogaria.model.Categorias;
import org.Farmacia.drogaria.repository.CategoriasRepository;
...
public class CategoriasController {
	...
	@PutMapping
	public ResponseEntity<Categorias> pust (@RequestBody Categorias categorias){
		return ResponseEntity.status(HttpStatus.CREATED).body(repository.save(categorias));
	}
